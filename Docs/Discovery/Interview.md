...
Ответ: Один основной пользователь на локальном настольном компьютере.
...
Ответ: Один базовый игровой сценарий: поле с минами, открытие клеток, установка флагов, победа и поражение.
...
Класс вопроса: Граница
Ответ: Онлайн-режим, пользовательские профили, сохранения, редактор уровней и упаковка в инсталлятор.

### 5. Какое ограничение сильнее всего влияет на первый pass продукта?
Класс вопроса: Ограничение
Ответ: Ограничение времени и узкого проверяемого scope.
...
Ответ: Пользователь текущего прохода утверждает границу результата и поставляет обязательные входы.

### 7. Какой вопрос нужно задать немедленно, если он блокирует следующий шаг?
Класс вопроса: Переход
Ответ: Блокирующих вопросов после подтверждения delta-интервью нет.

### 8. Какие вопросы можно перенести в следующую фазу без блокировки старта?
Класс вопроса: Переход
Ответ: Вопросы о будущих режимах, настройках, упаковке и расширенной поставке переносятся в следующую фазу.
