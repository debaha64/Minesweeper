...
## Desktop UI
- Игра использует `tkinter` из стандартной библиотеки Python.
- В Linux-средах без графической сессии автоматические тесты можно запускать без UI через `python3 -m unittest`.
